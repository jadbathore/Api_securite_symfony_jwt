 ...
 */
final class Version20241003124957 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE company ADD user_id INT DEFAULT NULL, ADD role_user VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE company DROP user_id, DROP role_user');
    }
}
